...
public class Config {
    ...
    public static String InvalidFile = "Error loading file";
    public static String InvalidPlayer = "Invalid Player";
    public static String InvalidOption = "Invalid Option";
    public static String InvalidInput = "Invalid Input";
    public static String InvalidTeam = "Equipa ja existe\n";
    public static String noTeam = "There is no such team\n";
    public static String GuardaRedes = "nome, numero, velocidade, resistencia, destreza, impulsao, cabeca, remate, passe, elasticidade";
    public static String Jogador = "nome, numero, velocidade, resistencia, destreza, impulsao, jogo_cabeça, remate, passe";
    public static String Medio = "nome, numero, velocidade, resistencia, destreza, impulsao, jogo_cabeça, remate, passe, recuperacao";
    public static String Lateral = "nome, numero, velocidade, resistencia, destreza, impulsao, jogo_cabeça, remate, passe, recuperacao, cruzamento";
